...
def process_item(content_json, output_file):
    ...
    success, llm_output = generate_content_with_image(block_image, merge)
    if success:
        tmp = parse_model_output(llm_output)
